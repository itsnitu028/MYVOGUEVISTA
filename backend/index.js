...
mongoose.connect('mongodb+srv://itsnitu028:Nitika%401234@cluster0.atohcsn.mongodb.net/ecommerce');
...
app.post('/upload',upload.single('product'),(req,res)=>{
    res.json({
        success:1,
        image_url:`https://voguevista-backend.onrender.com/images/${req.file.filename}`
    })
})
